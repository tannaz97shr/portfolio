...
export default function HeroSection() {
  return (
    <div className="flex flex-col-reverse p-6 lg:flex-row bg-primary-teal lg:bg-gradient-to-r from-primary-teal to-secondary-teal md:aspect-video xl:aspect-[5/2] items-center justify-center">
